...
const ProtectedLayout = () => {
  ...
  return (
    <div className="h-screen h-[100dvh] flex flex-col bg-gray-50/40 animate-page-enter">
      <Navbar onToggleSidebar={() => setMobileSidebarOpen(!mobileSidebarOpen)} />
      <div className="flex-1 min-h-0 pt-[61px] md:pl-64 flex flex-col relative overflow-hidden">
        <Sidebar isOpen={mobileSidebarOpen} onClose={() => setMobileSidebarOpen(false)} />
        <main className={`w-full flex-1 min-h-0 min-w-0 ${isChatPage ? 'p-0 flex flex-col overflow-hidden' : 'p-4 md:p-8 overflow-y-auto'} animate-page-enter`}>
          <Outlet />
        </main>
      </div>
    </div>
